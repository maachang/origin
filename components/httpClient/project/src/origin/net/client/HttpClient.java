...
public class HttpClient {
    ...
    private static final String USER_AGENT = "origin";
     ...
     */
    public static final HttpResult connect(String method, String url,
            Object params, Map header) throws IOException {
        HttpResult ret = null;
        int cnt = 0;
        while (true) {
    ...
    // 接続処理.
    private static final HttpResult _connect(String method, String url,
            Object params, Map header) throws IOException {
        Socket socket = null;
        InputStream in = null;
    ...
    // HTTPリクエストを作成.
    private static final byte[] createHttpRequest(String method,
            String[] urlArray, String params, Map header) throws IOException {
        byte[] b = null;
    ...
    private static final HttpResult receive(String url, InputStream in)
        ...
        HttpClientBuffer buffer = new HttpClientBuffer();
        ...
        // chunked用.
        int chunkedLength = -1;
        HttpClientBuffer chunkedBuffer = null;
                    ...
                    if ((p = buffer.indexOf(END_HEADER)) != -1) {
                        ...
                        // chunked.
                            ...
                            if ("chunked".equals(value)) {
                                bodyLength = -1;
                                chunkedBuffer = new HttpClientBuffer();
                            }
                        }
    ...
    // gzip解凍.
    private static final byte[] ungzip(byte[] b, byte[] o, HttpClientBuffer io)
            throws IOException {
        int len;
    ...
    // chunkedデータ長を取得.
    private static final int getChunkedLength(int p, HttpClientBuffer io, byte[] o)
            throws IOException {
        io.read(o, 0, p);
        io.skip(2);
    ...
    private static final boolean isNumeric(Object num) {
        try {
